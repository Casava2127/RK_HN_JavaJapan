...
import java.awt.BorderLayout; // Thư viện để sử dụng bố cục BorderLayout
import java.awt.Color;        // Thư viện để sử dụng các màu sắc
import java.awt.event.ActionEvent;  // Thư viện để xử lý sự kiện
import java.awt.event.ActionListener; // Thư viện để lắng nghe sự kiện

import javax.swing.JButton;  // Thư viện để tạo nút bấm
import javax.swing.JFrame;   // Thư viện để tạo cửa sổ JFrame
import javax.swing.JPanel;   // Thư viện để tạo Panel chứa các thành phần giao diện
import javax.swing.JTextArea; // Thư viện để tạo vùng nhập liệu
