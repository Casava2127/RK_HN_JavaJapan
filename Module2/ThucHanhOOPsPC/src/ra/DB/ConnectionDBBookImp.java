...
public class ConnectionDBBookImp { // Khai báo lớp ConnectionDB.

    // URL của CSDL cần kết nối đến
    private static final String URL = "jdbc:mysql://localhost:3306/bookimpdb"; // Địa chỉ URL của cơ sở dữ liệu MySQL.
